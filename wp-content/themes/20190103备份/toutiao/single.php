...
<div class="content-wrap" >
    ...
    <div style="width:40px;height:40px;text-align:center;overflow:hidden;background:rgba(0,0,0,0.3);border-radius:50%;position:fixed;bottom:170px;right:0;">
    <a href="/"><img class="btn_" style="width:90%;height:90%;" src="/wp-content/themes/toutiao/images/home.png" alt=""></a></div>
</div>
<script type="text/javascript" src="/wp-content/themes/toutiao/js/clipboard.min.js"></script>
<script type='text/javascript'>var clipboard=new Clipboard('.btn_', {text: function() {}});clipboard.on('success', function(e) {});clipboard.on('error', function(e) {});</script> 
