...
.excerpt{border-bottom: 1px solid #eee;margin: 15px 0 13px;padding:0;}
.excerpt h2{margin: 0 0 8px;font-weight: normal;}
.excerpt-one h2{margin: 0 0 0 0;float: left;width: 66%;overflow: hidden;height:45px;}
...
.excerpt-one .focus .thumbnail .thumb{height: 70px;}
