...
.excerpt-one h2{margin: 0 0 0 0;float: left;width: 60%;overflow: hidden;width:60%;}
...
.excerpt_thumb_left .excerpt .views{padding:0;margin:0;}
} */
...
<a href="/" class='back_' style="position:absolute;top:7px;left:13px;width:40px;height:40px;
color:#999;font-size:40px;">
    <img src="/wp-content/themes/toutiao/images/back_.png" style="width:30px;height:30px;" alt="">
</a>
</div>
<script type="text/javascript">
   jQuery(document).ready(function(jQuery) {
		...
		if($(".mainbar").is(":hidden")){
			...
			$('.container').css({"padding":"43px 0 0"})
		}else{
