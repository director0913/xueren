...
.article-meta .user_info{padding-bottom: 10px;}
.user_info .name_1{
    margin: 0;
    line-height: 17px;
    font-size: 14px;
...
@media (max-width: 480px){
    .wrapper{padding: 0px;}
    .user_info .time_1{margin-left: 0px;}
    .related_wrapper{padding: 0px;}
	    	...
	    	if( _hui('author_link') ){
	        	$author = '<a href="'.get_author_posts_url( get_the_author_meta( 'ID' ) ).'">'.$author.'</a>'; } ?>
					<div class="user_info">
						...
						<div>
							<p class="name_1"><?php echo $author ?><span class="time_1" style="float:right;"><?php echo formatTime( get_gmt_from_date(get_the_time('Y-m-d G:i:s')) ); ?></span></p>
						</div>
					</div>
