...
function prefix_insert_post_ads( $content ) {
	...
	if($from == 'gionee_screen'){
		$ad_code = '<div class="ads ads-content ads-comment"><script class="j-getAdParam" src="https://sspzx.gionee.com/JS_Ad/build/index.js?app_id=4052&adslot_id=4334"></script></div>';
	}elseif($from == 'gionee_browser' || $from == 'gionee_screen_2'){
