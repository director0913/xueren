...
//历史 这个是接口
$url = 'http://www.miercn.com/lishifeed';
$api = 'http://www.miercn.com/zbs/getDatanew?type=3&page=';
set_time_limit(0);
// 获取页码
function getPages($url){
	...
	for ($i=1; $i < 10; $i++) { 
		$listInfo = file_get_contents('http://www.miercn.com/zbs/getDatanew?type=3&page='.$i);
...
function getInfo($url){
	...
	if ($html) {
		$info = $html->find('div.J-contain_detail_cnt',0)->innertext ;
		return $info;
	}
	return '';
}
